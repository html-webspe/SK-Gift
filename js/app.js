(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".stories__slider")) new Swiper(".stories__slider", {
        ...
        if (document.querySelector(".construct__slider")) {
            const constructSliders = document.querySelectorAll(".construct__slider");
            constructSliders.forEach((constructSlider => {
                const prev = constructSlider.closest(".construct__block").querySelector(".construct__control-prev");
                const nex = constructSlider.closest(".construct__block").querySelector(".construct__control-next");
                new Swiper(constructSlider, {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
    ...
    if (searchAction) searchAction.addEventListener("click", (function(e) {
        document.documentElement.classList.toggle("search-open");
    }));
    const stories = document.querySelectorAll(".item-stories");
    if (stories) stories.forEach((el => {
        let videoId = el.querySelector(".stories-js").getAttribute("data-modal-youtube");
